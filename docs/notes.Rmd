...
\end{align*}$$ 
enter through the narrow gate; for the gate is wide and the road is easy that leads to destruction&mdash;the golden rule: in steady state where $K_t+1 = K_t = K$,
$$
\begin{align*}
